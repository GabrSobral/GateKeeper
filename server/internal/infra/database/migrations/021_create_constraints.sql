...
/* app_mfa_code >- application_user */
ALTER TABLE
    app_mfa_code
ADD
    CONSTRAINT fk_user_app_mfa_code FOREIGN KEY (user_id) REFERENCES "application_user" (id) ON DELETE CASCADE;

/* mfa_user_secret >- application_user */
ALTER TABLE
    mfa_user_secret
ADD
    CONSTRAINT fk_user_mfa_user_secret FOREIGN KEY (user_id) REFERENCES "application_user" (id) ON DELETE CASCADE;
...
ALTER TABLE
    app_mfa_code DROP CONSTRAINT fk_user_app_mfa_code;
